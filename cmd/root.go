...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.godesort.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".godesort" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".godesort")
	}
